    ...
    Module.postRun.push(function (Module) {
        ...
        const StructBinder = function StructBinder(structName, structInfo) {
          ...
          Object.keys(structInfo.members).forEach((k) => {
            ...
            if (!m.sizeof) toss(structName, 'member', k, 'is missing sizeof.');
              ...
              m.signature === 'c' || m.signature === 'C' || toss('Unexpected sizeof==1 member', sPropName(structInfo.name, k), 'with signature', m.signature);
            } else {
              if (0 !== m.sizeof % 4) {
      ...
      globalThis.sqlite3ApiBootstrap.initializers.push(function (sqlite3) {
...

        {
          ...
          wasm.xWrap.argAdapter('sqlite3_filename', __xArgPtr)('sqlite3_context*', __xArgPtr)('sqlite3_value*', __xArgPtr)('void*', __xArgPtr)('sqlite3_changegroup*', __xArgPtr)(
            'sqlite3_changeset_iter*',
            __xArgPtr
          )('sqlite3_session*', __xArgPtr)('sqlite3_stmt*', (v) => __xArgPtr(v instanceof (sqlite3?.oo1?.Stmt || nilType) ? v.pointer : v))('sqlite3*', (v) =>
            __xArgPtr(v instanceof (sqlite3?.oo1?.DB || nilType) ? v.pointer : v)
          )('sqlite3_index_info*', (v) => __xArgPtr(v instanceof (capi.sqlite3_index_info || nilType) ? v.pointer : v))('sqlite3_module*', (v) =>
            __xArgPtr(v instanceof (capi.sqlite3_module || nilType) ? v.pointer : v)
          )('sqlite3_vfs*', (v) => {
            if ('string' === typeof v) {
          ...
          wasm.xWrap.resultAdapter('sqlite3*', __xRcPtr)('sqlite3_context*', __xRcPtr)('sqlite3_stmt*', __xRcPtr)('sqlite3_value*', __xRcPtr)('sqlite3_vfs*', __xRcPtr)(
            'void*',
            __xRcPtr
          );
...

        {
          ...
          capi.sqlite3_create_window_function = function f(pDb, funcName, nArg, eTextRep, pApp, xStep, xFinal, xValue, xInverse, xDestroy) {
            ...
            try {
              ...
              if (
                0 === rc &&
                (xStep instanceof Function || xFinal instanceof Function || xValue instanceof Function || xInverse instanceof Function || xDestroy instanceof Function)
              ) {
      ...
      globalThis.sqlite3ApiBootstrap.initializers.push(function (sqlite3) {
        sqlite3.version = {
          ...
          sourceId: '2024-01-30 16:01:20 e876e51a0ed5c5b3126f52e532044363a014bc594cfefa87ffb5b82257cc467a',
        ...
        sqlite3.initWorker1API = function () {
          ...
          globalThis.onmessage = async function (ev) {
            ...
            try {
              ...
              if (0) sqlite3.config.warn('Worker is propagating an exception to main thread.', 'Reporting it _here_ for the stack trace:', err, result);
            }
            if (!dbId) {
